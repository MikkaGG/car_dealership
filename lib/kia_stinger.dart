...
class KiaStinger extends StatelessWidget {
  const KiaStinger({Key? key}) : super(key: key);
      ...
      body: Container(
        child: Column(
          ...
          children: [
              ...
              child: ListView(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: TextButton(
                        onPressed: () {
                          Navigator.pushNamedAndRemoveUntil(context, '/picanto', (route) => false);
                        },
                        child: Text('Picanto'),
                        style: TextButton.styleFrom(primary: Colors.black)),
                  ),
            ...
            Image.asset('assets/kia_stinger.jpg'),
            SizedBox(
              height: 30.0,
            ),
            Text(
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.pushNamedAndRemoveUntil(context, '/infStinger', (route) => false);
              },
