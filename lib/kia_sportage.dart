...
class KiaSportage extends StatelessWidget {
  const KiaSportage({super.key});
      ...
      body: Container(
        child: Column(
          ...
          children: [
            ...
            Image.asset('assets/kia_sportage.jpg'),
            SizedBox(
              height: 30.0,
            ),
            Text(
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.pushNamedAndRemoveUntil(context, '/infSportage', (route) => false);
              },
